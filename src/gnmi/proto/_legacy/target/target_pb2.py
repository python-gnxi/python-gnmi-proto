...
_CONFIGURATION_REQUESTENTRY.fields_by_name['value'].message_type = gnmi_dot_proto_dot___legacy_dot_gnmi_dot_gnmi__pb2._SUBSCRIBEREQUEST
...
Configuration = _reflection.GeneratedProtocolMessageType('Configuration', (_message.Message,), {
  ...
  'RequestEntry' : _reflection.GeneratedProtocolMessageType('RequestEntry', (_message.Message,), {
    ...
    '__module__' : 'gnmi.proto._legacy.target.target_pb2'
