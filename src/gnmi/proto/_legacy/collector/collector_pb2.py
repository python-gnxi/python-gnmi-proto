...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='gnmi/proto/_legacy/collector/collector.proto',
  package='gnmi',
  syntax='proto3',
  serialized_options=b'Z!gnmi/proto/_legacy/collector;gnmi',
...
ReconnectRequest = _reflection.GeneratedProtocolMessageType('ReconnectRequest', (_message.Message,), {
  ...
  '__module__' : 'gnmi.proto._legacy.collector.collector_pb2'
